...
public class MeleeTreeManager : BaseBehaviorTree
{
    ...
    public override void Start()
    {
        ...
        root.childNodes[1].childNodes.Add(new Check("Tree", detectRange));
        root.childNodes[1].childNodes.Add(new MoveTo(attackRange));
        root.childNodes[1].childNodes.Add(new Attack());

        root.childNodes[2].childNodes.Add(new Check("Player", detectRange));
        root.childNodes[2].childNodes.Add(new Chase());
        root.childNodes[2].childNodes.Add(new Attack());

        root.childNodes[3].childNodes.Add(new Check("Build", detectRange));
        root.childNodes[3].childNodes.Add(new MoveTo(attackRange));
        root.childNodes[3].childNodes.Add(new Attack());

        root.childNodes[4].childNodes.Add(new Check("Apples", detectRange));
        root.childNodes[4].childNodes.Add(new MoveTo(appleRange));
        root.childNodes[4].childNodes.Add(new EatApple());
